...
class TestAgentAllocationAPI:
    ...
    async def test_allocate_agent_success(self, mock_auth_service, mock_get_user, async_client, mock_auth_headers, mock_agency_id, mock_team_id):
    ...
    @pytest.mark.asyncio
    async def test_allocate_agent_missing_fields(self, async_client, mock_auth_headers):
...
class TestTaskExecutionAPI:
    ...
    async def test_execute_task_synchronous(self, mock_get_user, async_client, mock_auth_headers):
    ...
    @pytest.mark.asyncio
    @patch('app.api.tasks.get_current_user')
    async def test_execute_task_asynchronous(self, mock_get_user, async_client, mock_auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_execute_task_missing_inputs(self, async_client, mock_auth_headers):
...
class TestTaskQueueAPI:
    ...
    @pytest.mark.asyncio
    @patch('app.api.tasks.get_current_user')
    async def test_list_tasks_for_agent(self, mock_get_user, async_client, mock_auth_headers):
    ...
    @pytest.mark.asyncio
    @patch('app.api.tasks.get_current_user')
    async def test_get_task_status(self, mock_get_user, async_client, mock_auth_headers):
    ...
    @pytest.mark.asyncio
    @patch('app.api.tasks.get_current_user')
    async def test_cancel_task(self, mock_get_user, async_client, mock_auth_headers):
...
class TestAgentListAPI:
    ...
    @pytest.mark.asyncio
    @patch('app.api.agents.get_current_user')
    async def test_list_agents_for_team(self, mock_get_user, async_client, mock_auth_headers):
    ...
    @pytest.mark.asyncio
    @patch('app.api.agents.get_current_user')
    async def test_get_agent_details(self, mock_get_user, async_client, mock_auth_headers):
...
class TestAuthorizationMiddleware:
    ...
    @patch('app.api.agents.get_current_user')
    @patch('app.api.agents.authorization_service')
    async def test_validates_agency_admin(self, mock_auth_service, mock_get_user, async_client, mock_auth_headers):
...
class TestRateLimiting:
    ...
    @pytest.mark.asyncio
    @patch('app.api.tasks.get_current_user')
    async def test_rate_limit_task_execution(self, mock_get_user, async_client, mock_auth_headers):
